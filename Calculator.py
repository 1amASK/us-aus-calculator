...
if perform == "convert":
    ...
    type = str(input("What currecncy is it? usd or aud: ")).lower()
    end_type = str(input("What currecncy do you want it to be? usd or aud: ")).lower()
    ...
    second_type = str(input("What currecncy is it? usd or aud: ")).lower()
    end_type = str(input("What currecncy do you want it to be? usd or aud: ")).lower()
    if perform == "add":
